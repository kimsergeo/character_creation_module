...
def attack(char_name, char_class):
    ...
    :param char_class: class of character
...
def start_training(char_name, char_class):
    ...
    print(
        'Введи одну из команд: attack — чтобы атаковать противника, defence — чтобы '
        'блокировать атаку противника или special — чтобы использовать свою суперсилу.')
...
def choice_char_class():
    ...
    :return: result of character selection
    """
    approve_choice = None
    char_class = None
